...
namespace SMBC
{
	...
	{
		std::vector<SMBC::Entity*> ObjectList = {};
	...
	private:
		...
		static void Bind_NoSeparation		 (ConvertedModel& cModel, SMBC::Entity* object, const bool& is_joint, const std::size_t& body_idx);
		static void Bind_SeparateJoints		 (ConvertedModel& cModel, SMBC::Entity* object, const bool& is_joint, const std::size_t& body_idx);
		static void Bind_SeparateUuid		 (ConvertedModel& cModel, SMBC::Entity* object, const bool& is_joint, const std::size_t& body_idx);
		static void Bind_SeparateColor		 (ConvertedModel& cModel, SMBC::Entity* object, const bool& is_joint, const std::size_t& body_idx);
		static void Bind_SeparateUuidAndColor(ConvertedModel& cModel, SMBC::Entity* object, const bool& is_joint, const std::size_t& body_idx);
		...
		void (*CollectionBindFunction)(ConvertedModel&, SMBC::Entity*, const bool&, const std::size_t&) = nullptr;
